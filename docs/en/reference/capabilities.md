...
| `getSession()` | Verified | Read run state from run_status, not status. Source-reviewed additions: nullable run_status and optional numeric pending_approvals count. |
